...
std::string BufferComponent::getModuleInstantiation(std::string tabs){
	setInputPortBus();
	setOutputPortBus();
...
std::string BufferComponent::getVerilogParameters(){
	std::string ret;
...
std::string BufferComponent::getInputOutputConnections(){
	std::string ret;
